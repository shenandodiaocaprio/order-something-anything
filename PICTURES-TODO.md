# KopeFood — Full Picture List (with descriptions)

Every dish, its filename, and the exact description shown on the site.
Generate a 500×500 PNG, name it **exactly** as shown, upload to the repo, tell me → it goes live.

**Legend:** ✅ DONE · 🆕 new stall · 🔄 replace Wikimedia photo · ⬜ emoji only (no photo yet)
...
---
**Total images needed: 63**  (Boba's 9 already done.)

## ChatGPT prompt template
> Photorealistic top-down food photograph of **[DISH]**, a Singapore hawker dish, plated simply, centered in frame, appetizing, soft natural studio lighting, shallow depth of field, clean neutral light background, no text, no hands. Square 1:1, 500×500px.